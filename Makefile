...
run_tests: src/run_tests.o src/ExternalSources/fec.o
	$(CXX) -o $@ $^ $(_LDFLAGS)
...
clean:
	rm -rf env wfb_rx wfb_tx wfb_keygen run_tests dist deb_dist build wifibroadcast.egg-info _trial_temp *~ src/*.o src/ExternalSources/*.o
