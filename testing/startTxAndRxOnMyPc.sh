...
gnome-terminal -- $WFB_FOLDER/wfb_tx -M 4 -k 4 -n 8 -u 6002 -p 60 -K $WFB_FOLDER/drone.key $MY_TX

$WFB_FOLDER/wfb_rx -k 4 -n 8 -c 127.0.0.1 -u 6001 -p 60 -K $WFB_FOLDER/gs.key $MY_RX
